<template>
    <div class="goods">
                ...
                <div class="center">
                    ...
                    >
                        <el-form-item label="选择司机">
                            ...
                            ></el-input>
                            <el-button type="primary" style="margin-left:13px;" @click="search()">查找</el-button>
            ...
            <div class="nav2">
                ...
                <div class="center">
                    ...
                    >
                        ...
                        <el-form-item required label="期望运费">
                            <el-input-number
        ...
        <addDriverNew ref="addDriverNew" @search="search"></addDriverNew>
    </div>
</template>
<script>
...
import addDriverNew from '../popup/addDriver.vue';
export default {
    data() {
        return {
    ...
    methods: {
        ...
        mapList(list) {
            list.map((item) => {
                if (this.popupData.drph == item.ph) {
                    this.form3.search = item.ph;

                    this.form3.did = item.tid;
                }
            });
            // console.log(this.form3.did);
        },
        ...
        async assign() {
            ...
            if (this.form2.service < 0) {
                this.open2('司服务费不能为空');
                return;
            }
            if (this.form2.freight.length == 0) {
                this.open2('期望运费不能为空');
                return;
            } else {
                let bd = {
