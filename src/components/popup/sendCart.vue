...
export default {
    ...
    methods: {
        ...
        receipt(index, row) {
            ...
            console.log(this.$store.state.Login.popup);
        ...
        assign() {
            ...
            if (this.formLabelAlign.freight.length == 0) {
                this.open2('司机运费不能为空');
                this.button3 = true;
                setTimeout(() => {
                    this.button3 = false;
            ...
            if (this.formLabelAlign.service.length == 0) {
            ...
            if (this.formLabelAlign.startTime.length == 0) {
                this.open2('装货时间不能为空');
                this.button3 = true;
                setTimeout(() => {
                    this.button3 = false;
